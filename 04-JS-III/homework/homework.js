...
function numeroMasGrande(numeros) {
  ...
  // Tu código:
  var gra = numeros.sort(function (a , b) {return b - a})
  return gra[0]
}
...
function diaDeLaSemana(numeroDeDia) {
  ...
  //si el día corr00esponde a Sábado o Domingo y “Es dia Laboral” en caso contrario. 
  //Escribe tu código aquí 
...
function mayorACien(array) {
  ...
  var mayor = [] 
  for (var i = 0 ; i < array.length ; i++) {
    if (array[i] >= 101) { mayor.push(array[i]) }  }
 return mayor
}
